      ...
      <div class="py-5 text-center col-md-4">
      	...
      	<form action="customerReport.jsp" onsubmit="return logincontrol();">
 			...
 			<img class="mr-2" src="images/chen/bad.png" width="33" height="33">
      		<input type="submit" value="客訴回報" class="btn btn-outline-danger">
      	</form>	
      </div>
     </div>
...
<!-- 			從DB抓房東不出租的日期 -->
			...
			<br /> <input type="submit" value="預訂" class="btn btn-primary">
		</form>
        </div>
        	...
        	<h4 class="mb-3 text-secondary">房間設備</h4>        
            	<div class="row">
            		<div class="col-md-4 mb-3 order-md-2">
                		<img id="picture1" class="ml-1" src="" width="220" height="140" alt="">
  						<hr/>
  						<img id="picture2" class="ml-1" src="" width="220" height="140" alt="">
  						<hr/>
  						<img id="picture3" class="ml-1" src="" width="220" height="140" alt="">
  						<hr/>
  						<img id="picture4" class="ml-1" src="" width="220" height="140" alt="">
  						<hr/>
...
function logincontrol(){
	...
	$.ajax("${pageContext.request.contextPath}/house/"+houseID, {
		...
		$("#picture1").attr("src", json.housePicture1);
// 		$("#picture2").attr("src", json.housePicture2);
// 		$("#picture3").attr("src", json.housePicture3);
// 		$("#picture4").attr("src", json.housePicture4);
