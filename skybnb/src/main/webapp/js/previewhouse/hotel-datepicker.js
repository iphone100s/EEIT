...
var HotelDatepicker = function HotelDatepicker(input, options) {
	...
	this.i18n = opts.i18n || {
		...
		nights: '晚',
		button: '關閉',
		'checkin-disabled': '無法Check-in',
		'checkout-disabled': '無法Check-out',
		...
		'error-more': '區間必須大於 1 晚',
		'error-more-plural': '區間不可大於  %d 晚',
		'error-less': '區間必須小於 1 晚',
		'error-less-plural': '區間不可小於  %d 晚',
		'info-more': '請至少選擇住宿 1 晚',
		'info-more-plural': '請至少選擇住宿  %d 晚',
		'info-range': '選擇的區間請介於 %d 與  %d 晚',
		'info-default': '請選擇一個日期區間'
	};
//	this.i18n = opts.i18n || {
//		selected: 'Your stay:',
//		night: 'Night',
